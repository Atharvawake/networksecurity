...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        """
        it initilaize a KNNImputer object with the parameters specified
        ...
        try:
            ...
            logging.info(
                f"Initilaise KNNImputer with {DATA_TRANSFORMATION_IMPUTER_PARAMS}"
            )
    ...
    def initiate_data_transformaation(self) -> DataTransformationArtifacts:
